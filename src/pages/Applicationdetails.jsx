    ...
    const [ loading, setLoading ] = useState(true);
      ...
      useEffect(() => {
           const fetch_data = async () => {
              try{
                ...
                setData(filter_by_id(response.data.applications, id));
                setLoading(false)
              }
              catch(e){
                  if(e.response){
     ...
     <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3  mb-3 ">
      <div className="d-flex flex-row align-items-center">
        ...
        <h1 className="fs-6 fw-bold text-white">Application Details</h1>
      </div>
                 ...
                 <>
                  {
                      ...
                      <h1 className="fs-5 text-center my-2 fw-bold">Application Details</h1> 
                        <div className="my-2">
                      <p className="my-0">Username</p>     
                        <p>{items.user.name}</p>     
                       </div>
                       <div className="my-2">
                      <p className="my-0">PetName</p>     
                        <p>{items.pet.name}</p>     
                       </div>
                       <div className="my-2">
                       ...
                       <div className="my-2">
                        ...
                        onClick={() => {
                          ...
                          Delete Application
                            ...
                            <Link to={`/update-application/${items.id}`} className="w-50 link">
                  ...
                  <div className="alert alert-warning">
                   <p className="fs-6 fw-bold">Opps could not find application details</p>
                  </div>
                )
            }
          </div>
