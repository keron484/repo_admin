...
function EmailDetails(){
  ...
  useEffect(() => {
      const fetch_emails = async () => {
            try{
                ...
                setEmail(filter_by_id(response.data.emails, id));
                setLoading(false);
            }
            catch{
  ...
  const handle_delete = async (id) => {
      try{
         ...
         setDeleteerror("An error occured while deleting");
      }
  }
    return(
        <>
   <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3  mb-3 ">
    <div className="d-flex flex-row align-items-center">
      ...
      <h1 className="fs-6 fw-bold text-white">Email Details</h1>
    </div>
               ...
               <>
                {
                    ...
                    <div className="my-2">
                    <p className="my-0">Name Of Reciepient</p>     
                      <p>{items.name}</p>     
                      </div>
                      <div className="my-2">
                    <p className="my-0">Email Of Reciepient</p>     
                     ...
                     <div className="my-2">
                      ...
                      <button className="fs-12 btn btn-danger w-100" 
                      onClick={() => {
